...
Requires the following files (produced by the notebook) to be in the
SAME folder as this script:
    - disease_classifier_model.pkl
    - tfidf_vectorizer.pkl
    - disease_categories.pkl
    - clinical_trials_cleaned.csv   (optional, only used for the EDA tab)
"""
